...
def getBuses(route=''):
    ...
    for bus in buses:
        output = bus['ROUTE'] + '  LAT:' + bus['LATITUDE'] + '  LON:' + bus['LONGITUDE'] + '  ADHER:' + bus[
            'ADHERENCE'] + '  VEHICLE:' + bus['VEHICLE'] + '\n' + '  TRIP:' + bus['TRIPID']
...
def getTrains(station=''):
    ...
    for train in trains:
        ...
        if prediction:
            output = 'dir: ' + train['Direction'] + '  Waiting_Seconds:' + str(
                train['Waiting_Seconds']) + '  LOCATION:' + train['Location'] + '  TRACK:' + train[
                         'Track'] + '\n' + '  ID:' + train['Train_ID'] + '\n'
        else:
            output = train['Direction'] + '  LAT:' + train['Latitude'] + '  LON:' + train['Longitude'] + '  LOCATION:' + \
                     train['Location'] + '  TRACK:' + train['Track'] + '\n' + '  ID:' + train['Train_ID'] + '\n'
        print(output)
